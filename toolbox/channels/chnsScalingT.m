function [lambdas,as,scales,fs] = chnsScalingT( pChns, Is, show )
...
pPyramid=chnsPyramidT(); pPyramid.pChns=pChns; pPyramid.concat=0;
...
P=chnsPyramidT(Is{1},pPyramid); scales=P.scales'; info=P.info;
nScales=P.nScales; nTypes=P.nTypes; fs=zeros(nImages,nScales,nTypes);
parfor i=1:nImages, P=chnsPyramidT(Is{i},pPyramid); for j=1:nScales
